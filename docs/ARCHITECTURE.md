...
| Strict completion proves more | Evidence dereference plus required server-run command | The write token is therefore command-execution-grade; see [SECURITY.md](../SECURITY.md). |
